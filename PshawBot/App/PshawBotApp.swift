...
// PshawBot
//
// The main entry point for the PshawBot macOS application.
//
// Architecture:
...
struct PshawBotApp: App {
    ...
    private let logger = Logger(subsystem: "com.pshawbot", category: "App")
    ...
    var body: some Scene {
        ...
        Window("PshawBot Inspector", id: "main") {
        ...
        MenuBarExtra("PshawBot", systemImage: "eye.trianglebadge.exclamationmark") {
            MenuBarContent()
                .environment(appState)
        }
...
struct PermissionRequestView: View {
    ...
    var body: some View {
        VStack(spacing: 24) {
            ...
            Text("PshawBot needs screen recording permission to\nunderstand what's on your display.")
